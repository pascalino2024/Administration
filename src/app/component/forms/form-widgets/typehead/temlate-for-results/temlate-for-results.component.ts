...
@Component({
  selector: 'app-temlate-for-results',
  standalone: true,
  imports: [CommonModule,FormsModule,NgbModule],
  templateUrl: './temlate-for-results.component.html',
  styleUrls: ['./temlate-for-results.component.scss']
})
export class TemlateForResultsComponent {
