...
import { EditProfileFormComponent } from '../../../user/user-edit/edit-profile-form/edit-profile-form.component';
import { GeneralComponent } from './edit-profile/general/general.component';
import { AddressContantComponent } from './edit-profile/address-contant/address-contant.component';
import { PersonalContantComponent } from './edit-profile/personal-contant/personal-contant.component';

@Component({
  selector: 'app-profile-data',
  standalone: true,
  imports: [CommonModule, EditProfileFormComponent, GeneralComponent, AddressContantComponent, PersonalContantComponent,
    GeneralComponent ,PrintComponent],
