...
@Component({
  selector: 'app-tabs',
  standalone: true,
  imports: [CommonModule, BorderTabsComponent, IconsTabsComponent, JustifyTabsComponent, MaterialStyleTabsComponent, MaterialStyleLeftTabsComponent
    , PillsTabsComponent, SimpleTabsComponent, VerticalTabsComponent],
